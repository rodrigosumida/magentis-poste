...
class Jogador:
    def __init__(self, x, y):
        ...
        # Sprites
        self.sprite_parado = self.carregar_sprite("Peter_Griffin.png")
        self.sprite_travado = self.carregar_sprite("morte.png")
        self.frames = [self.carregar_sprite(f"frame_{i}_delay-0.1s.gif") for i in range(7)]
